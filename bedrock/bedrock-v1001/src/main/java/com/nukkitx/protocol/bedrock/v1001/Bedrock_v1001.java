package com.nukkitx.protocol.bedrock.v1001;
...
import com.nukkitx.protocol.bedrock.v1001.serializer.StartGameSerializer_v1001;
...
@UtilityClass
public class Bedrock_v1001 {
    public static final BedrockPacketCodec Bedrock_v1001 = BedrockPacketCodec.builder()
            ...
            .registerPacket(ResourcePacksInfoPacket.class, ResourcePacksInfoSerializer_v818.INSTANCE, 6)
            ...
            .registerPacket(StartGamePacket.class, StartGameSerializer_v1001.INSTANCE, 11)
            ...
            .registerPacket(LevelChunkPacket.class, LevelChunkSerializer_v649.INSTANCE, 58)
            ...
            .registerPacket(TransferPacket.class, TransferSerializer_v729.INSTANCE, 85)
