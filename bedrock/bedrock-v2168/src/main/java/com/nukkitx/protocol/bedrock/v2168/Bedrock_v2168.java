...
import com.nukkitx.protocol.bedrock.v2168.serializer.LevelChunkSerializer_v2168;
import com.nukkitx.protocol.bedrock.v2168.serializer.MovePlayerSerializer_v2168;
import com.nukkitx.protocol.bedrock.v2168.serializer.ResourcePackClientResponseSerializer_v2168;
import com.nukkitx.protocol.bedrock.v2168.serializer.ResourcePacksInfoSerializer_v2168;
import com.nukkitx.protocol.bedrock.v2168.serializer.StartGameSerializer_v2168;
import com.nukkitx.protocol.bedrock.v2168.serializer.TransferSerializer_v2168;
...
import com.nukkitx.protocol.bedrock.v662.serializer.SetEntityMotionSerializer_v662;
...
import com.nukkitx.protocol.bedrock.v800.serializer.BiomeDefinitionListSerializer_v800;
import com.nukkitx.protocol.bedrock.v898.serializer.ResourcePackStackSerializer_v898;
import com.nukkitx.protocol.bedrock.v975.serializer.DisconnectSerializer_v975;
import lombok.experimental.UtilityClass;

@UtilityClass
public class Bedrock_v2168 {
    public static final BedrockPacketCodec Bedrock_v2168 = BedrockPacketCodec.builder()
            .raknetProtocolVersion(11)
            .prefixed(true)
            .protocolVersion(2168)
            .minecraftVersion("1.26.40")
            .helper(BedrockPacketHelper_v2168.INSTANCE)
            ...
            .registerPacket(DisconnectPacket.class, DisconnectSerializer_v975.INSTANCE, 5)
            .registerPacket(ResourcePacksInfoPacket.class, ResourcePacksInfoSerializer_v2168.INSTANCE, 6)
            .registerPacket(ResourcePackStackPacket.class, ResourcePackStackSerializer_v898.INSTANCE, 7)
            .registerPacket(ResourcePackClientResponsePacket.class, ResourcePackClientResponseSerializer_v2168.INSTANCE, 8)
            ...
            .registerPacket(StartGamePacket.class, StartGameSerializer_v2168.INSTANCE, 11)
            ...
            .registerPacket(MovePlayerPacket.class, MovePlayerSerializer_v2168.INSTANCE, 19)
            // RiderJumpPacket.class 20
            ...
            .registerPacket(SetEntityMotionPacket.class, SetEntityMotionSerializer_v662.INSTANCE, 40)
            ...
            .registerPacket(LevelChunkPacket.class, LevelChunkSerializer_v2168.INSTANCE, 58)
            ...
            .registerPacket(TransferPacket.class, TransferSerializer_v2168.INSTANCE, 85)
            ...
            .registerPacket(BiomeDefinitionListPacket.class, BiomeDefinitionListSerializer_v800.INSTANCE, 122)
