package com.nukkitx.protocol.bedrock.v712;
...
@UtilityClass
public class Bedrock_v712 {
    public static final BedrockPacketCodec Bedrock_v712 = BedrockPacketCodec.builder()
            ...
            .registerPacket(ResourcePacksInfoPacket.class, ResourcePacksInfoSerializer_v712.INSTANCE, 6)
