package com.nukkitx.protocol.bedrock.v786;
...
@UtilityClass
public class Bedrock_v786 {
    public static final BedrockPacketCodec Bedrock_v786 = BedrockPacketCodec.builder()
            .raknetProtocolVersion(11)
            .prefixed(true)
            .protocolVersion(786)
            .minecraftVersion("1.21.71")
