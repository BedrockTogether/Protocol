package com.nukkitx.protocol.bedrock.v818;
...
@UtilityClass
public class Bedrock_v818 {
    public static final BedrockPacketCodec Bedrock_v818 = BedrockPacketCodec.builder()
            ...
            .registerPacket(StartGamePacket.class, StartGameSerializer_v818.INSTANCE, 11)
