package com.nukkitx.protocol.bedrock.v827;
...
@UtilityClass
public class Bedrock_v827 {
    public static final BedrockPacketCodec Bedrock_v827 = BedrockPacketCodec.builder()
            ...
            .registerPacket(ResourcePackStackPacket.class, ResourcePackStackSerializer_v671.INSTANCE, 7)
            ...
            .registerPacket(StartGamePacket.class, StartGameSerializer_v827.INSTANCE, 11)
