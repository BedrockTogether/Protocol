package com.nukkitx.protocol.bedrock.v975;
...
@UtilityClass
public class Bedrock_v975 {
    public static final BedrockPacketCodec Bedrock_v975 = BedrockPacketCodec.builder()
            ...
            .registerPacket(StartGamePacket.class, StartGameSerializer_v924.INSTANCE, 11)
