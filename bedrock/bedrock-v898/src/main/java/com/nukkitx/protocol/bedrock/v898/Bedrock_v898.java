package com.nukkitx.protocol.bedrock.v898;
...
@UtilityClass
public class Bedrock_v898 {
    public static final BedrockPacketCodec Bedrock_v898 = BedrockPacketCodec.builder()
            ...
            .registerPacket(StartGamePacket.class, StartGameSerializer_v898.INSTANCE, 11)
