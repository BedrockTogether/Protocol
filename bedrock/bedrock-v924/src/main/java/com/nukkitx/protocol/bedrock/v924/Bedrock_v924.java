package com.nukkitx.protocol.bedrock.v924;
...
@UtilityClass
public class Bedrock_v924 {
    public static final BedrockPacketCodec Bedrock_v924 = BedrockPacketCodec.builder()
            ...
            .registerPacket(DisconnectPacket.class, DisconnectSerializer_v712.INSTANCE, 5)
