package com.nukkitx.protocol.bedrock.v800;
...
@UtilityClass
public class Bedrock_v800 {
    public static final BedrockPacketCodec Bedrock_v800 = BedrockPacketCodec.builder()
            ...
            .registerPacket(ResourcePacksInfoPacket.class, ResourcePacksInfoSerializer_v765.INSTANCE, 6)
            ...
            .registerPacket(StartGamePacket.class, StartGameSerializer_v776.INSTANCE, 11)
